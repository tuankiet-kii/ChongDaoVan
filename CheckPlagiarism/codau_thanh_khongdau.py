...
if __name__ == '__main__':
    timkiem = input("Nhập nội dụng: ")
    for i in search(timkiem,stop=5,lang="vn"):
        html = requests.get(i).text
        soup = BeautifulSoup(html)
        heads = soup.find_all("p")
        print(i)
        for head in heads:
            chuoi = head.text
            rs = usenltk(timkiem,chuoi)
            if(rs > 50.00):
                print("--Đoạn văn tìm thấy:-- "+chuoi.lstrip()+"\n\n")
