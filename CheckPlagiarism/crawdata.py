...
# timkiem = input("- Nhập nội dung cần tìm: ")
# mang_timkiem = timkiem.split()
# dem_timkiem = 0
# for i in mang_timkiem:
#     dem_timkiem+=1

dem = 0
html = requests.get("https://download.vn/viet-doan-van-ta-ve-que-huong-em-41528").text
soup = BeautifulSoup(html)
heads = soup.findAll('p')
dem += 1
print("-STT-------" + str(dem))
for head in heads:
    print(head.text)
    print("\n")
    # mang_head = str(head.text).split()
    # tong = 0
    # for a in mang_timkiem:
    #     for b in mang_head:
    #         if (a.__contains__(b)):
    #             tong += 1
    # if (tong > dem_timkiem*2):
    #     print("Đoạn văn trùng khớp: "+str(head.text))
    #     print("Tỉ lệ trùng khớp: "+kiemtradaovan1(timkiem,str(head.text)))
