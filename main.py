...
# label tên ứng dụng
Label(f1, text='HỆ THỐNG KIỂM TRA ĐẠO VĂN ( PYTHON )',bg="pink",font=("Arial",28,'bold')).pack(pady=30)
variable1 = StringVar(f1)
variable1.set("Pink")# default value
w1 = OptionMenu(f1, variable1,"Pink", "MySQL", "Data on Computer")
...
box1 = Text(f1, width=115, height=10, font=("Arial",15))
box1.pack(pady=0)
# nút mở file
btn_openfile1 = Button(f1,text="Open File",font=("Arial",12),bg="blue",fg="white",command=open_file1)
btn_openfile1.place(x=350,y=360)

variable = StringVar(f1)
variable.set("Internet")# default value
w = OptionMenu(f1, variable,"Internet", "MySQL", "Data on Computer")
w.config(width=15,font=("Arial",12),bg='orange',fg='white')
w.place(x=500,y=360)

# nút tìm kiếm văn bản
btn_timkiem1 = Button(f1,text="Text Search",font=("Arial",12),bg="green",fg="white",command=timkiem1)
btn_timkiem1.place(x=720,y=360)
# nút xóa văn bản
Button(f1,text="Delete",font=("Arial",12),bg="red",fg="white",width=5,command=xoa1).place(x=880,y=360)
...
#-----------------------------------------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------------------------------------
# bb = Button(root,text="hello",command=open_f1)
...
class slider:
    def __init__(self,root):
        ...
        Fram_slider.place(x=400,y=60,width=600,height=400)
        ...
        self.x = 600
        self.slider_func()
        Label(self.root,text="CHÀO MỪNG BẠN ĐẾN VỚI HỆ THỐNG CHỐNG ĐẠO VĂN",font=("Arial",30,'bold')).place(x=130,y=500)
        Button(self.root,text="ĐĂNG NHẬP VÀO ỨNG DỤNG",width=40,height=2,bg="light green").place(y=650,x=550)
